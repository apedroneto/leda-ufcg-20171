...
public class StudentSortingTest {
    ...
    public void setUp() {
        ...
        populaVetorNegativo(new Integer[]{-1, 2, -54, -6, -1, 2, 0, 3, 6, 0, -8});
    ...
    public void testSort08() {
        genericRangeTest(vetorRange, 2, vetorRange.length);
    }

    @Test
    public void testSort09() {
        genericRangeTest(vetorRange, 2, vetorRange.length - 3);
    }
