...
public class Util {
    ...
    public static Integer getMinValue(Integer[] array, int leftIndex, int rightIndex) {
        Integer minVal = array[leftIndex];
    ...
    public static Integer getMaxValue(Integer[] array, int leftIndex, int rightIndex) {
        Integer maxVal = array[leftIndex];
        for (int i = leftIndex; i <= rightIndex; i++) {
